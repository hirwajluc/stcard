				...
				<div class="card m-b-30">
					<div class="card-body">
						...
						<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
							...
							<tr>
								<td><?=$student['regno'];?></td>
								<td><?php if(@getimagesize(base_url('assets/images/profile/' . $student['regno'] . '.jpg'))){ ?><img width="50px" height="60px" src="<?= base_url('assets/images/profile/' . $student['regno'].'.jpg'); ?>"/><?php }else{ echo "No Photo";} ?></td>
								<td><?=$student['fname']. " ".$student['lname'];?></td>
								<td><?=$student['department'];?></td>
								<td><?=$student['options'];?></td>
								<td><?= $CI->numberTowords($student['year']);?></td>
								<td><?=$student['phone']!=0?"0".$student['phone']:"No Phone";?></td>
								<td>
									<a href="<?=base_url();?>card/gen_one_card/<?=$student['regno'];?>" target="_blank" class="btn btn-primary waves-effect waves-light">Front</a> <a href="<?=base_url();?>card/gen_one_card_back/<?=$student['regno'];?>" target="_blank" class="btn btn-success waves-effect waves-light">Back</a>
									<?php
									if (@getimagesize(base_url('assets/images/profile/' . $student['regno'] . '.jpg'))) {}else{
									?>
										<a href="<?=base_url();?>card/upload_picture/<?=$student['regno'];?>" target="_blank" class="btn btn-primary waves-effect waves-light">Upload Picture</a>
									<?php } ?>
								</td>
							</tr>
							<?php } ?>
