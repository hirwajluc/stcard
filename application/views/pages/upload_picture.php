		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					...
					<h4 class="page-title">Picture Uploading</h4>
				</div>
			</div>
		</div>
			...
			<div class="col-12">
				<div class="card m-b-30">
					<div class="card-body">
						...
						<h4 class="mt-0 header-title">Upload picture for <?=$regno;?></h4>

						<form class="form-group" action="<?=base_url();?>card/picture_uploading" method="post" enctype="multipart/form-data">
							<input type="hidden" name="regno" value="<?=$regno?>" />
							<input type="file" name="picture" placeholder="Upload Student Photo" />
